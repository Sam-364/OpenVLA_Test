...
class RobotDataset(Dataset):
    ...
    Supports RLDS format and custom robot datasets
    """
    ...
    def _load_dataset(self) -> List[Dict]:
        ...
        # based on your specific dataset format (RLDS, custom, etc.)
        samples = []
        
        # Example structure for BridgeData V2 format
...
class OpenVLATrainer:
    ...
    def __init__(self, config: OpenVLAConfig, model: OpenVLA, 
                 train_dataset: Dataset, val_dataset: Optional[Dataset] = None,
